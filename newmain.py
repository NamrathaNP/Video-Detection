...
while True:
    ...
    socketio.emit('newframe', {'hourly_count_dict_male': hourly_count_dict_male, 'hourly_count_dict_female': hourly_count_dict_female,'totalMale':totalMale, 'totalFemale':totalFemale, 'frame':frame })
...
# def video_feed():
#     return render_template('main.html', frame=frame)
